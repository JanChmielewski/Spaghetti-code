        ...
        while (choice != "Q") {
            ...
            switch (choice) {
                ...
                case "4":
                    ...
                    break;
                case "5":
                    System.out.println("There are: " + odd.oddAmount() + " odd numbers");

                    break;
                case "6":
                    System.out.println("There are: " + even.evenAmount() + " even numbers");

                    break;
                case "7":
                    System.out.println("The sum of the first half is: " + firstSum.printFirstHalfSum());

                    break;
                case "8":
                    System.out.println("The sum of the second half is: " + secondSum.printSecondHalfSum());
                    break;
                case "9":
                    Integer firstHalf = firstSum.printFirstHalfSum();
                    Integer secondHalf = secondSum.printSecondHalfSum();
